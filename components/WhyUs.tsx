...
export default function WhyUs() {
  return (
    <section className={styles.whyUs} id="why-us" aria-labelledby="why-us-heading">
      <div className={styles.sectionContainer}>
        <div className={styles.whyContent}>
          <h2 id="why-us-heading" className="serif">Why PSC</h2>
          <p>We believe the youth sports landscape is strongest when clubs are supported, families are educated, and expectations are realistic.</p>
